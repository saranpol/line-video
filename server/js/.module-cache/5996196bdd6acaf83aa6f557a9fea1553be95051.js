var Me = React.createClass({displayName: "Me",
    ...
    render: function() {
        ...
        if(this.state.gotData){
            ...
            var locationStyle = {width:"100%"};
            var ss = {"background-color":"#FF00FF"};

            content = (
                React.createElement("div", {className: "row"}, 
                    React.createElement("div", {style: ss, className: "col-md-4"}, 
                        React.createElement("img", {style: locationStyle, src: "http://www.geeksandcleats.com/wp-content/uploads/2014/08/Cristiano-Ronaldo-shirtless-geeksandcleats-e1409262047693.jpg", className: "img-thumbnail"})
                    ), 
                    React.createElement("div", {className: "col-md-8"}, 
                        React.createElement("form", {className: "form-horizontal", onSubmit: this.saveData}, 
                            ...
                            React.createElement("div", {className: "form-group"}, 
                                ...
                                React.createElement("div", {className: "col-sm-9 form-inline"}, 
                            ...
                            React.createElement("div", {className: "form-group"}, 
                                ...
                                React.createElement("div", {className: "col-sm-9"}, 
                                    React.createElement("p", {className: "form-control-static"}, "เช่น ว่าง 18:00น. - 20:00น. ก็ติ๊ก 18 19 20")
                                )
                            ), 
                            ...
                            React.createElement("div", {className: "form-group"}, 
                                ...
                                React.createElement("div", {className: "col-sm-9"}, 
                                    ...
                                    "ท่านสามารถเลื่อนหมุดบนแผนที่เพื่อเปลี่ยนตำแหน่ง", 
                                    React.createElement("div", {id: "locationPicker", style: locationStyle}), 
                                    React.createElement("button", {type: "button", onClick: this.updateCurrentLocation, className: "btn btn-default"}, "ไปยังตำแหน่งปัจจุบันของท่าน"), " (ท่านอาจจะต้องกดอนุญาตให้ใช้ตำแหน่งด้วย)"
                                )
                            ), 

                            React.createElement("div", {className: "form-group"}, 
                                React.createElement("div", {className: "col-sm-offset-2 col-sm-9"}, 
...
var InputTitle = React.createClass({displayName: "InputTitle",
    render: function() {
        return (
            React.createElement("label", {className: "col-sm-3 control-label"}, this.props.title)
        );
    }
});
