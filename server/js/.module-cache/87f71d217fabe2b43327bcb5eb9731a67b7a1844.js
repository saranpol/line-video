var Me = React.createClass({displayName: "Me",
    ...
    updateMeData: function() {
        FB.api('/me?fields=first_name,last_name,email,birthday', function(res) {
            ...
            inputEmail.state.inputText = res.email;
            inputEmail.setState();
        }.bind(this));
    },
    render: function() {
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "col-sm-10"}, 
                    React.createElement("input", {ref: "input", type: p.type, className: "form-control", placeholder: p.placeholder, value: this.state.inputText})
                )
            )
        );
    }
