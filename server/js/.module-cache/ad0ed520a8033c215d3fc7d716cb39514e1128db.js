...
"มีอาการบาดเจ็บเล็กน้อยแต่พอเล่นได้ (30%)" + ' ' +    
...
"ช่วงเวลาที่น่าจะว่างใน 1 สัปดาห์" + ' ' +
...
"รูปถ่ายเต็มตัว แนวตั้ง 3:4",  
                    ...
                    React.createElement(TextInput, {ref: "inputWeight", type: "number", name: "น้ำหนัก"}), " กก.", 
                    React.createElement(TextInput, {ref: "inputHeight", type: "number", name: "ส่วนสูง"}), " ซม.", 
                    React.createElement("label", {className: "radio-inline"}, React.createElement("input", {type: "number", className: "form-control"}), " บาท"), 
...
//                 <InputTitle title={p.name}/>
//                 <div className="col-sm-10">
//                     <div className="form-inline">
//                     <input ref="input" type={p.type} className="form-control" placeholder={placeholder} value={p.value}/>
//                 </div>
//             </div>
//         );
//     }
// <div className="form-group">
//                         <InputTitle title="ค่าตัว"/>
//                         <div className="col-sm-10">
//                             <div className="form-inline">
//                                 <InputRadio name="man_hour" value="-1" title="ฟรี ช่วยออกค่าสนาม"/>
//                                 <InputRadio name="man_hour" value="0" title="ฟรี ไม่ออกค่าสนาม"/>
//                                 <InputRadio name="man_hour" value="1" title="ชั่วโมงละ"/>
//                                 <label className="radio-inline"><input type="number" className="form-control"/> บาท</label>
//                             </div>
//                         </div>
//                     </div>
// });
