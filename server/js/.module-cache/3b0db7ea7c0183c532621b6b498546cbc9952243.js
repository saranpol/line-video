var Nav = React.createClass({displayName: "Nav",
    ...
    render: function() {
        ...
        if(this.state.isLogin){
            ...
            logoutButton = (React.createElement("div", {className: "text-profile"}, "xx", React.createElement("br", null), React.createElement("a", {href: "#", onClick: this.clickLogout, className: "logout-link"}, "Logout")));
        }
