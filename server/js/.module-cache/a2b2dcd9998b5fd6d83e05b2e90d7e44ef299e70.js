var Me = React.createClass({displayName: "Me",
    ...
    render: function() {
        ...
        var loadingContent = (React.createElement("h1", null, "กำลังโหลดข้อมูล"));
        if(this.state.gotUserData){
            content = (
                React.createElement("form", {className: "form-horizontal"}, 
                    React.createElement(TextInput, {ref: "inputFirstName", type: "text", name: "ชื่อ", value: this.state.userJson.FirstName}), 
