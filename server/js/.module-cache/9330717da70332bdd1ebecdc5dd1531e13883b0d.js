...
var ProfileImage = React.createClass({displayName: "ProfileImage",
    ...
    render: function() {
        ...
        var progressDiv = ('');
        if(this.state.percent > 0 && this.state.percent < 101){
            progressDiv = ( 
                React.createElement("div", {className: "progress"}, 
                    React.createElement("div", {className: "progress-bar", role: "progressbar", "aria-valuenow": "50", "aria-valuemin": "0", "aria-valuemax": "100", style: progressStyle}, 
                        this.state.percent, "%"
                    )
                ));
        }
