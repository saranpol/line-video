    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("button", {className: "btn btn-xs btn-default", onClick: this.clickFindPlayer}, "ฉันต้องการหานักเตะร่วมทีม"), 
                React.createElement("button", {onClick: this.clickIAmPlayer}, "ฉันต้องการให้คนชวนเล่นฟุตบอล และสามารถมีรายได้จากการเล่นด้วย"), 
