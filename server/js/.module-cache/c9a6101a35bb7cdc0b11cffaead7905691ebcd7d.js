...
"รูปถ่ายเต็มตัว แนวตั้ง 3:4",  
                    ...
                    React.createElement(TextInputInline, {ref: "inputWeight", type: "number", name: "น้ำหนัก"}), " กก.", 

                    React.createElement(TextInputInline, {ref: "inputHeight", type: "number", name: "ส่วนสูง"}), " ซม.", 
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("div", {className: "col-sm-10 form-inline"}, 
                    React.createElement("label", {ref: "input", className: "radio-inline"}, React.createElement("input", {type: "number", className: "form-control"}), " ", p.afterText)
                )
            )
        );
    }
