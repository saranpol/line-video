                            ...
                            React.createElement("div", {className: "form-horizontal"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10"}, 
                                        ...
                                        React.createElement(InputCheckBox, {ref: "input", title: "เตะเล่นแถวบ้าน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลโรงเรียน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลมหาลัย"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลจังหวัด"})
                                        ), 
                                        React.createElement("div", null, 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลทีมอิสระเดินสาย"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลสโมสร"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "นักฟุตบอลทีมชาติ"})
                                        )
                                    )
                                ), 
