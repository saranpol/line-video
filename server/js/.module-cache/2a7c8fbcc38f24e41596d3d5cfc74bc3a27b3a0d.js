        ...
        return (
            React.createElement("div", null, 
                React.createElement("form", {className: "form-horizontal"}, 
                    ...
                    React.createElement(TextInput, {ref: "inputEmail", type: "email", name: "Email"}), 
                    React.createElement(TextInput, {ref: "inputUsername", type: "text", name: "Username จะใช้เป็นชื่อ url ด้วย เช่น www.nugtae.com/your_username"}), 
                    React.createElement(TextInput, {ref: "inputPassword", type: "password", name: "Password", placeholder: "Password ใส่เฉพาะเมื่อจะตั้งใหม่"}), 
...
var TextInput = React.createClass({displayName: "TextInput",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                React.createElement("label", {className: "col-sm-2 control-label"}, p.placeholder), 
