var Nav = React.createClass({displayName: "Nav",
    ...
    render: function() {
        ...
        if(this.state.isLogin){
            ...
            logoutButton = (React.createElement("div", {className: "text-profile"}, React.createElement("h1", null, "xxxxxxxxxxxxxxx"), React.createElement("a", {href: "#", onClick: this.clickLogout, className: "logout-link"}, "Logout")));
        }
