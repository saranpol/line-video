var Me = React.createClass({displayName: "Me",
    ...
    render: function() {
        ...
        if(this.state.userJson != null){
            var locationStyle = {width:"100%", height:"400px"};
            var j = this.state.userJson;
            content = (
                React.createElement("form", {className: "form-horizontal"}, 
                    React.createElement(TextInput, {ref: "inputFirstName", type: "text", name: "ชื่อ", value: j.FirstName}), 
                    React.createElement(TextInput, {ref: "inputLastName", type: "text", name: "นามสกุล", value: j.LastName}), 
                    React.createElement(TextInput, {ref: "inputNickName", type: "text", name: "ชื่อเล่น"}), 
                    React.createElement(TextInput, {ref: "inputEmail", type: "email", name: "อีเมล์", value: j.Email}), 
                    ...
                    React.createElement("div", {className: "form-group"}, 
                        ...
                        React.createElement("div", {className: "col-sm-10"}, 
                            React.createElement(InputRadio, {name: "", value: "-1", title: "ฟรี ช่วยออกค่าสนาม"}), 
                            React.createElement(InputRadio, {name: "", value: "0", title: "ฟรี ไม่ช่วยออกค่าสนาม"}), 
                            React.createElement(InputRadio, {name: "", value: "1", title: "ชั่วโมงละ"})
                        )
                    ), 
...
var InputRadio = React.createClass({displayName: "InputRadio",
    render: function() {
        var p = this.props;
        return (
            React.createElement("label", {class: "radio-inline"}, React.createElement("input", {type: "radio", name: p.name, value: p.value}), p.title)
        );
    }
});
