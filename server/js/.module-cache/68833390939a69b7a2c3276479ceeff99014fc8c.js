var Index = React.createClass({displayName: "Index",
        ...
        this.request = $.ajax({
            ...
            success: function(json) {
                if(json.Success == 1){
                    ...
                    $.cookie("FirstName", this.state.FB_userID, { expires: 100000 });
    ...
    render: function() {
        return (
            React.createElement("div", {className: "bg-main"}, 
                React.createElement(Nav, {FB_userID: this.state.FB_userID}), 
                React.createElement("div", {className: "container"}, 
                    React.createElement("div", {className: "row text-center"}, 
                        React.createElement("h1", null, "\"มาเตะบอลกัน\"")
                    ), 
                    React.createElement("div", {className: "row"}, 
                        ...
                        React.createElement("div", {className: "col-md-6 text-center"}, 
                            React.createElement("button", {className: "btn btn-primary btn-lg btn-tall", onClick: this.clickIAmPlayer}, "ให้คนชวนเล่นฟุตบอล", React.createElement("br", null), React.createElement("img", {src: "/img/login_with_facebook.png", width: "202px", height: "46px"}))
                        )
                    )
                )
            )
