                ...
                React.createElement("form", {className: "row", onSubmit: this.saveData}, 
                    React.createElement("div", {className: "col-md-4"}, 
                        ...
                        React.createElement("div", {className: "form-horizontal"}, 
                            ...
                            React.createElement("input", {ref: "inputYoutubeURL", type: p.type, className: "form-control", placeholder: placeholder, value: p.value}), 
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                React.createElement("div", {className: "col-sm-12 form-inline"}, 
                    p.name, " ", React.createElement("input", {ref: "input", type: "number", className: "form-control", placeholder: p.name}), " ", p.afterText
                )
            )
        );
    }
