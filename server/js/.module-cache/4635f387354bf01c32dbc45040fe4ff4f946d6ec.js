                        ...
                        React.createElement("div", {className: "col-md-8"}, 
                            React.createElement("div", {className: "form-horizontal"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10"}, 
                                        React.createElement(InputCheckBox, {ref: "input", title: "หญ้าแท้"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "หญ้าเทียม"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "พื้นแข็ง (คอนกรีต, ฟุตซอล)"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ทราย"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ดิน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "เปียกฝน"})
                                    )
                                ), 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10"}, 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ข้างละ 11 คน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ข้างละ 7-9 คน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ข้างละ 3-6 คน"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ข้างละ > 11 คน"})
                                    )
                                ), 
