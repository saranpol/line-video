var Me = React.createClass({displayName: "Me",
    ...
    updateMeData: function() {
        ...
        this.request = $.ajax({
            ...
            success: function(json) {
                ...
                if(json.Username != ""){
                    $.cookie("username", json.Username, { expires: 100000 });
                }
                ...
                r.inputTimeNormalDay.setValue(9, json.TimeNormalDay9);
                r.inputTimeNormalDay.setValue(10, json.TimeNormalDay10);
                r.inputTimeNormalDay.setValue(11, json.TimeNormalDay11);
                r.inputTimeNormalDay.setValue(12, json.TimeNormalDay12);
                r.inputTimeNormalDay.setValue(13, json.TimeNormalDay13);
                r.inputTimeNormalDay.setValue(14, json.TimeNormalDay14);
                r.inputTimeNormalDay.setValue(15, json.TimeNormalDay15);
                r.inputTimeNormalDay.setValue(16, json.TimeNormalDay16);
                r.inputTimeNormalDay.setValue(17, json.TimeNormalDay17);
                r.inputTimeNormalDay.setValue(18, json.TimeNormalDay18);
                r.inputTimeNormalDay.setValue(19, json.TimeNormalDay19);
                r.inputTimeNormalDay.setValue(20, json.TimeNormalDay20);
                r.inputTimeNormalDay.setValue(21, json.TimeNormalDay21);
                r.inputTimeNormalDay.setValue(22, json.TimeNormalDay22);
                r.inputTimeNormalDay.setValue(23, json.TimeNormalDay23);
                r.inputTimeNormalDay.setValue(0, json.TimeNormalDay0);
                r.inputTimeNormalDay.setValue(1, json.TimeNormalDay1);
                r.inputTimeNormalDay.setValue(2, json.TimeNormalDay2);
                r.inputTimeNormalDay.setValue(3, json.TimeNormalDay3);

                r.inputTimeSatDay.setValue(9, json.TimeSatDay9);
                r.inputTimeSatDay.setValue(10, json.TimeSatDay10);
                r.inputTimeSatDay.setValue(11, json.TimeSatDay11);
                r.inputTimeSatDay.setValue(12, json.TimeSatDay12);
                r.inputTimeSatDay.setValue(13, json.TimeSatDay13);
                r.inputTimeSatDay.setValue(14, json.TimeSatDay14);
                r.inputTimeSatDay.setValue(15, json.TimeSatDay15);
                r.inputTimeSatDay.setValue(16, json.TimeSatDay16);
                r.inputTimeSatDay.setValue(17, json.TimeSatDay17);
                r.inputTimeSatDay.setValue(18, json.TimeSatDay18);
                r.inputTimeSatDay.setValue(19, json.TimeSatDay19);
                r.inputTimeSatDay.setValue(20, json.TimeSatDay20);
                r.inputTimeSatDay.setValue(21, json.TimeSatDay21);
                r.inputTimeSatDay.setValue(22, json.TimeSatDay22);
                r.inputTimeSatDay.setValue(23, json.TimeSatDay23);
                r.inputTimeSatDay.setValue(0, json.TimeSatDay0);
                r.inputTimeSatDay.setValue(1, json.TimeSatDay1);
                r.inputTimeSatDay.setValue(2, json.TimeSatDay2);
                r.inputTimeSatDay.setValue(3, json.TimeSatDay3);

                r.inputTimeSunDay.setValue(9, json.TimeSunDay9);
                r.inputTimeSunDay.setValue(10, json.TimeSunDay10);
                r.inputTimeSunDay.setValue(11, json.TimeSunDay11);
                r.inputTimeSunDay.setValue(12, json.TimeSunDay12);
                r.inputTimeSunDay.setValue(13, json.TimeSunDay13);
                r.inputTimeSunDay.setValue(14, json.TimeSunDay14);
                r.inputTimeSunDay.setValue(15, json.TimeSunDay15);
                r.inputTimeSunDay.setValue(16, json.TimeSunDay16);
                r.inputTimeSunDay.setValue(17, json.TimeSunDay17);
                r.inputTimeSunDay.setValue(18, json.TimeSunDay18);
                r.inputTimeSunDay.setValue(19, json.TimeSunDay19);
                r.inputTimeSunDay.setValue(20, json.TimeSunDay20);
                r.inputTimeSunDay.setValue(21, json.TimeSunDay21);
                r.inputTimeSunDay.setValue(22, json.TimeSunDay22);
                r.inputTimeSunDay.setValue(23, json.TimeSunDay23);
                r.inputTimeSunDay.setValue(0, json.TimeSunDay0);
                r.inputTimeSunDay.setValue(1, json.TimeSunDay1);
                r.inputTimeSunDay.setValue(2, json.TimeSunDay2);
                r.inputTimeSunDay.setValue(3, json.TimeSunDay3);

                r.inputTimeSpecialDay.setValue(9, json.TimeSpecialDay9);
                r.inputTimeSpecialDay.setValue(10, json.TimeSpecialDay10);
                r.inputTimeSpecialDay.setValue(11, json.TimeSpecialDay11);
                r.inputTimeSpecialDay.setValue(12, json.TimeSpecialDay12);
                r.inputTimeSpecialDay.setValue(13, json.TimeSpecialDay13);
                r.inputTimeSpecialDay.setValue(14, json.TimeSpecialDay14);
                r.inputTimeSpecialDay.setValue(15, json.TimeSpecialDay15);
                r.inputTimeSpecialDay.setValue(16, json.TimeSpecialDay16);
                r.inputTimeSpecialDay.setValue(17, json.TimeSpecialDay17);
                r.inputTimeSpecialDay.setValue(18, json.TimeSpecialDay18);
                r.inputTimeSpecialDay.setValue(19, json.TimeSpecialDay19);
                r.inputTimeSpecialDay.setValue(20, json.TimeSpecialDay20);
                r.inputTimeSpecialDay.setValue(21, json.TimeSpecialDay21);
                r.inputTimeSpecialDay.setValue(22, json.TimeSpecialDay22);
                r.inputTimeSpecialDay.setValue(23, json.TimeSpecialDay23);
                r.inputTimeSpecialDay.setValue(0, json.TimeSpecialDay0);
                r.inputTimeSpecialDay.setValue(1, json.TimeSpecialDay1);
                r.inputTimeSpecialDay.setValue(2, json.TimeSpecialDay2);
                r.inputTimeSpecialDay.setValue(3, json.TimeSpecialDay3);

                r.inputBodyWeight.setText(json.BodyWeight);
                r.inputBodyHeight.setText(json.BodyHeight);
                r.inputBodyFit.getDOMNode().value = json.BodyFit;

                r.inputYoutubeURL.getDOMNode().value = json.YoutubeURL;
    ...
    saveData: function(e) {
        ...
        var data = {
            ...
            BodyFit: r.inputBodyFit.getDOMNode().value,
        ...
        this.requestSaveData = $.ajax({
            ...
            success: function(json) {
                if(json.Success == 1){
                    ...
                    $.cookie("username", data.Username, { expires: 100000 });
                } else {
                    alert(json.Reason);
                }
            }.bind(this),
    ...
    disableCostHourBaht: function(){
        this.refs.inputCostHourBaht.getDOMNode().value = 0;
        this.refs.inputCostHourBaht.getDOMNode().disabled = true;
    },
    enableCostHourBaht: function(){
        this.refs.inputCostHourBaht.getDOMNode().disabled = false;
    },
    render: function() {
        var content;
                    ...
                    React.createElement("div", {className: "row"}, 
                            ...
                            React.createElement("div", {className: "form-horizontal"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10 form-inline"}, 
                                        React.createElement(InputRadio, {onSetTrue: this.disableCostHourBaht, ref: "inputCostFreeHelpField", name: "man_hour", title: "ฟรี ช่วยออกค่าสนาม"}), 
                                        React.createElement(InputRadio, {onSetTrue: this.disableCostHourBaht, ref: "inputCostFreeNoHelpField", name: "man_hour", title: "ฟรี ไม่ออกค่าสนาม"}), 
                        ...
                        React.createElement("div", {className: "form-group"}, 
                            React.createElement("div", {className: "col-sm-12 text-center"}, 
                                ...
                                React.createElement("button", {type: "submit", onClick: this.saveData, className: "btn btn-primary btn-lg btn-tall"}, "บันทึกข้อมูลนักเตะ")
                            )
                        )
...
var InputRadio = React.createClass({displayName: "InputRadio",
    checkCallBack: function() {
        if(this.refs.input.getDOMNode().checked && this.props.onSetTrue != undefined){
    ...
    render: function() {
        var p = this.props;
        return (
            React.createElement("label", {className: "radio-inline"}, React.createElement("input", {onChange: this.checkCallBack, ref: "input", type: "radio", name: p.name, value: p.value}), p.title)
        );
    }
});
