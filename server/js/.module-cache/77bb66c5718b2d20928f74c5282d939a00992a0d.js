    ...
    updateMeData: function() {
        ...
        this.request = $.ajax({
            ...
            success: function(json) {
                ...
                r.inputTimeSpecialDay.getValue(3),
...
var InputTimeRange = React.createClass({displayName: "InputTimeRange",
    setValue: function(h, v){
        ...
        switch(h){
            ...
            case 10: r.h9.setValue(v); break;
            case 11: r.h9.setValue(v); break;
            case 12: r.h9.setValue(v); break;
            case 13: r.h9.setValue(v); break;
            case 14: r.h9.setValue(v); break;
            case 15: r.h9.setValue(v); break;
            case 16: r.h9.setValue(v); break;
            case 17: r.h9.setValue(v); break;
            case 18: r.h9.setValue(v); break;
            case 19: r.h9.setValue(v); break;
            case 20: r.h9.setValue(v); break;
            case 21: r.h9.setValue(v); break;
            case 22: r.h9.setValue(v); break;
            case 23: r.h9.setValue(v); break;
            case 0: r.h9.setValue(v); break;
            case 1: r.h9.setValue(v); break;
            case 2: r.h9.setValue(v); break;
            case 3: r.h9.setValue(v); break;
        }
    },
    getValue: function(h) {
        var r = this.refs;
