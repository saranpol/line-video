...
function getBirthdayValue() {
  console.log($('#birth\\[month\\] option:selected').text());
  return "adsf";
  //return $('#birthdayPicker').datepicker('getDate');
  //$('#birth[month] option:selected').text() + '/' + $('#birth[day] option:selected').text() + '/' + $('#birth[year] option:selected').text();
}
