...
//         });
    ...
    render: function() {
        ...
        return (
            React.createElement("form", {action: "/upload", enctype: "multipart/form-data"}, 
        ...
        //         <img style={imgWidth} src="/img/test.jpg" className="img-thumbnail"/>
        //         <form id="uploadImageForm" ref="uploadForm" enctype="multipart/form-data">
                    
        //                 เปลี่ยนรูปของคุณ <input name="file" type="file"/>
