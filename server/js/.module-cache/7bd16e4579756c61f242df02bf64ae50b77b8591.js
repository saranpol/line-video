                            ...
                            React.createElement("div", {className: "form-horizontal"}, 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10"}, 
                                        ...
                                        React.createElement(InputCheckBox, {ref: "input", title: "มิดฟิลด์ตัวรับ"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "มิดฟิลด์ตัวรุก"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "มิดฟิลด์ด้านกว้าง"})
                                    )
                                ), 
                                ...
                                React.createElement("div", {className: "form-group"}, 
                                    ...
                                    React.createElement("div", {className: "col-sm-10"}, 
                                        React.createElement(InputCheckBox, {ref: "input", title: "เซ็นเตอร์ฟอร์เวิร์ด"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "กองหน้าตัวต่ำ"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ปีกซ้าย"}), 
                                        React.createElement(InputCheckBox, {ref: "input", title: "ปีกขวา"})
                                    )
                                ), 
