    ...
    render: function() {
        return (
            React.createElement("div", null, 
                ...
                React.createElement("button", {className: "btn btn-primary btn-lg", onClick: this.clickIAmPlayer}, "ฉันต้องการให้คนชวนเล่นฟุตบอล", React.createElement("br", null), "และสามารถมีรายได้จากการเล่นด้วย"), 
