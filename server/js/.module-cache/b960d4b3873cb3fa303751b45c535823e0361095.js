    ...
    render: function() {
        ...
        if(this.state.isLogin){
            if(this.props.FB_userID != ""){
                ...
                facebookImg = (React.createElement("div", {className: "img-profile"}, React.createElement("img", {src: url, className: "img-circle"})))
            }
            logoutButton = (React.createElement("div", {className: "text-profile"}, React.createElement("span", null, this.state.firstName), React.createElement("br", null), React.createElement("a", {href: "#", onClick: this.clickLogout, className: "logout-link"}, "Logout")));
        }
