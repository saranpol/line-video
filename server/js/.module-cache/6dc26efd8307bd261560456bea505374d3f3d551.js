    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                ...
                React.createElement("form", {action: "/upload", method: "POST", enctype: "multipart/form-data"}, 
"Upload File: ", React.createElement("input", {type: "file", name: "file"}), 
React.createElement("input", {type: "submit", name: "submit", value: "Submit"})
), 
                React.createElement("form", {id: "uploadImageForm", method: "POST", action: "/upload", ref: "uploadForm", enctype: "multipart/form-data"}, 
                    ...
                    React.createElement("input", {type: "submit", onClick: this.uploadImage, value: "Upload"}), 
                    this.state.percent
                )
            )
        );
