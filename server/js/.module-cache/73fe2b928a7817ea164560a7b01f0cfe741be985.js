...
var ResultList = React.createClass({displayName: "ResultList",
    render: function() {
        var search = this.prop.search;
        var userNodes = this.props.data.map(function (user) { return (React.createElement(User, {user: user, search: search})); });
        return (React.createElement("div", null, userNodes));
    }
});

var User = React.createClass({displayName: "User",
    calDistance: function(lat0,long0){
        var lat1 = this.props.search.lat;
        var long1 = this.props.search.long;
        return 100;
    },
    render: function() {
