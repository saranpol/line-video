...
var ProfileImage = React.createClass({displayName: "ProfileImage",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "form-group"}, 
                React.createElement("img", {style: imgWidth, src: "http://localhost:8080/_ah/img/n5hxv1XDoGPCcQHkSUyHIA===s600", className: "img-thumbnail"}), 
                ...
                React.createElement("form", {ref: "uploadForm", enctype: "multipart/form-data"}, 
                    React.createElement("span", {className: "btn btn-default btn-file"}, 
                        "เปลี่ยนรูปของคุณ ", React.createElement("input", {onChange: this.uploadImage, name: "file", type: "file"})
                    ), 
                    this.state.percent
                )
            )
