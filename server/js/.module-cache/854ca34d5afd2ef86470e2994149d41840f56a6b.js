        ...
        return (
            React.createElement("div", null, 
                React.createElement("form", {className: "form-horizontal"}, 
                    React.createElement(TextInput, {xref: "inputEmail", type: "email", placeholder: "Email"}), 
  ...
  render: function() {
    ...
    return (
        React.createElement("div", {className: "form-group"}, 
            ...
            React.createElement("div", {className: "col-sm-10"}, 
                React.createElement("input", {ref: "inputText", type: p.type, className: "form-control", placeholder: p.placeholder})
            )
        )
    );
  }
