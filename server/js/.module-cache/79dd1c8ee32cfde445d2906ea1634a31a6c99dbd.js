var Search = React.createClass({displayName: "Search",
    ...
    updateData: function() {
        ...
        var data = {
            ...
            h9: r.h9.getValue(),
            TimeSunDay10: r.inputTimeSunDay.getValue(),
            TimeSunDay11: r.inputTimeSunDay.getValue(),
            TimeSunDay12: r.inputTimeSunDay.getValue(),
            TimeSunDay13: r.inputTimeSunDay.getValue(),
            TimeSunDay14: r.inputTimeSunDay.getValue(),
            TimeSunDay15: r.inputTimeSunDay.getValue(),
            TimeSunDay16: r.inputTimeSunDay.getValue(),
            TimeSunDay17: r.inputTimeSunDay.getValue(),
            TimeSunDay18: r.inputTimeSunDay.getValue(),
            TimeSunDay19: r.inputTimeSunDay.getValue(),
            TimeSunDay20: r.inputTimeSunDay.getValue(),
            TimeSunDay21: r.inputTimeSunDay.getValue(),
            TimeSunDay22: r.inputTimeSunDay.getValue(),
            TimeSunDay23: r.inputTimeSunDay.getValue(),
            TimeSunDay0: r.inputTimeSunDay.getValue(),
            TimeSunDay1: r.inputTimeSunDay.getValue(),
            TimeSunDay2: r.inputTimeSunDay.getValue(),
            TimeSunDay3: r.inputTimeSunDay.getValue(),
        };
        alert(data);
        this.request = $.ajax({
            url: "search_user",
                ...
                React.createElement("div", {className: "container"}, 
                    React.createElement("div", {className: "row"}, 
                        ...
                        React.createElement("div", {className: "col-md-6"}, 
                            ...
                            React.createElement("select", {ref: "inputDay", className: "form-control"}, 
